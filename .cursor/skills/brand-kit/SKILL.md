...
Load `.cursor/skills/anti-slop/SKILL.md` first. Tokens here feed websites, banners, and social — do not encode Inter or a purple SaaS default. Do not invent photography in the brand file.
